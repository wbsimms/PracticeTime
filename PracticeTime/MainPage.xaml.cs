...
namespace PracticeTime
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void EntryButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            if (b != null)
            {
                if (b.Name == "AddEntry") NavigateTo(typeof(AddEntry));
                if (b.Name == "UpdateEntry") NavigateTo(typeof(UpdateEntry));
                if (b.Name == "DeleteEntry") NavigateTo(typeof(DeleteEntry));
            }
        }

        private void NavigateTo(Type t)
        {
